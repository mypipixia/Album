...
<head>
    ...
    <link href="/toshop/Public/Home/css/shop.css" rel="stylesheet">
...
<div class="all">
        ...
        <div class="container">
            ...
            <div class="navs">
                <nav class="navs-left">
                    ...
                    <a href="../Shop/shop.html" style="background: linear-gradient(to right,#37238D,#8D3099)">商城</a>
                    <a href="hotshop.html">热卖</a>
                    <a href="#">活动</a>
    ...
    <div class="containers">
        <div class="hot">
            <ul>
               <li class="hot-title">
                    <span>热销商品<span>HOT</span></span>
                    <span><a href="#">MORE</a></span>
                </li>
                <?php if(is_array($promp)): $i = 0; $__LIST__ = $promp;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mp): $mod = ($i % 2 );++$i;?><li class="hot-img" data-id="<?php echo ($mp["id"]); ?>">
                        <img src="/toshop/<?php echo ($mp["img"]); ?>" width="100%">
        ...
        <div class="new-shop">
            <ul>
                <li class="hot-title">
                    <span>演唱会<span>NEW</span></span>
                    <span><a href="#">MORE</a></span>
                </li>
                <?php if(is_array($pronewmp)): $i = 0; $__LIST__ = $pronewmp;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$newmp): $mod = ($i % 2 );++$i;?><li class="new-product" data-id="<?php echo ($newmp["id"]); ?>">
                        <img src="/toshop/<?php echo ($newmp["img"]); ?>"/>
                        <p><?php echo ($newmp["name"]); ?></p>
                        <span>￥<?php echo ($newmp["price"]); ?></span>
                        <span><?php echo ($newmp["sales"]); ?>人付款</span>
                    </li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
        </div>
        <div class="brand">
...
<script>
    $(function () {
        ...
        $('.album_').hover(function () {
            $(this).children('div').toggle()
        });
        $('.thum').hover(function () {
            $(this).children('.thumson').toggle()
        });
    })
</script>